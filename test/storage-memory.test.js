...
test('storage memory', async (t) => {
  ...
  test('set', async (t) => {
    ...
    test('should update the key references, case #1', async (t) => {
      const storage = createStorage('memory')
    ...
    test('should update the key references, case #2', async (t) => {
      const storage = createStorage('memory')
    ...
    test('should update the key references, case #3', async (t) => {
      const storage = createStorage('memory')
